  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-violet-50 to-background">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-[#3a4043] mb-2">Candidate Overview</h1>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mb-4">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-sm text-[#6f7a80]">{candidate.progress}%</span>
                        </div>
                      ...
                      {/* Key Strengths */}
                      <div className="mb-4">
                        <h4 className="font-medium text-[#3a4043] mb-2">Key Strengths:</h4>
                        <div className="flex flex-wrap gap-2">
                          {candidate.keyStrengths.map((strength, strengthIndex) => (
                            <Badge key={strengthIndex} variant="secondary" className="text-xs bg-green-100 text-green-800">
                              {strength}
                            </Badge>
                          ))}
                        </div>
                      ...
                      {candidate.areasForImprovement.length > 0 && (
                        <div className="mb-4">
                          <h4 className="font-medium text-[#3a4043] mb-2">Areas for Improvement:</h4>
                          <div className="flex flex-wrap gap-2">
                            {candidate.areasForImprovement.map((area, areaIndex) => (
                              <Badge key={areaIndex} variant="outline" className="text-xs border-yellow-300 text-yellow-700">
                                {area}
                              </Badge>
                            ))}
                          </div>
                      ...
                      {/* Accommodations */}
                      <div className="mb-4">
                        <h4 className="font-medium text-[#3a4043] mb-2">Accommodations:</h4>
                        <div className="flex flex-wrap gap-2">
                          {candidate.accommodations.map((accommodation, accIndex) => (
                            <Badge key={accIndex} variant="outline" className="text-xs border-purple-300 text-purple-700">
