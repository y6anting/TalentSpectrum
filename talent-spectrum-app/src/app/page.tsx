    ...
    >
      ...
      <div className="flex items-center justify-center pt-10 pb-12 px-4 overflow-visible">
        <div className="max-w-[1400px] w-full text-left">
          ...
          {/* Community and Shop Section */}
          <div className="mt-16">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Connect with Community Card */}
              <Link href="/login" target="_blank" rel="noopener noreferrer" className="group cursor-pointer">
                <div className="relative overflow-hidden rounded-2xl shadow-xl transition-transform duration-300 hover:scale-105 h-[250px]">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#635bff] to-[#9a96ff] opacity-90"></div>
                  <div className="relative h-full flex flex-col items-center justify-center p-6 text-center">
                    <svg className="w-16 h-16 text-white mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                    <h3 className="text-2xl font-bold text-white mb-3">
                      Connect with the<br />Neurodivergent Community
                    </h3>
                    <div className="inline-flex items-center gap-2 text-white group-hover:gap-4 transition-all">
                      <span className="text-base font-medium">Log In Now</span>
              ...
              {/* Empower Entrepreneurs Card */}
              <Link href="/marketplace" target="_blank" rel="noopener noreferrer" className="group cursor-pointer">
                <div className="relative overflow-hidden rounded-2xl shadow-xl transition-transform duration-300 hover:scale-105 h-[250px]">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#635bff] to-[#9a96ff] opacity-90"></div>
                  <div className="relative h-full flex flex-col items-center justify-center p-6 text-center">
                    <svg className="w-16 h-16 text-white mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-3">
                      Empower Neurodivergent<br />Entrepreneurs
                    </h3>
                    <div className="inline-flex items-center gap-2 text-white group-hover:gap-4 transition-all">
