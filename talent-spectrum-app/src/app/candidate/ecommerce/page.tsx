...
const EcommerceDashboardPage: React.FC = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      stock: 25,
      status: "Active",
      imageUrl: "/ecomm/gf_cookies.jfif",
    },
    {
      id: "p3",
  ...
  const orders = [
    {
      ...
      total: 57.5,
      status: "Processing",
      items: ["Hand-knitted Scarf", "Gluten-Free Chocolate Chip Cookies"],
    },
    {
      id: "o2",
    ...
    },
    {
      ...
      total: 12.5,
      status: "Delivered",
      items: ["Gluten-Free Chocolate Chip Cookies"],
    },
  ];
  ...
  const messages = [
    {
      id: "m1",
      sender: "Alice Smith",
      senderAvatar: "/ecomm/chat/alice_smith.png",
    ...
    },
    {
      ...
      senderAvatar: "/ecomm/chat/ts_logo.png",
      lastMessage: "Awesome, thanks for the update!",
      time: "Yesterday",
      chatHistory: [
        {
          type: "received",
          text: 'Your new product listing for "Hand-knitted Scarf" is now live!',
        },
    ...
    },
    {
      id: "m3",
      sender: "Bob Johnson",
      senderAvatar: "/ecomm/chat/bob_johnson.png",
      lastMessage: "You're very welcome, Bob! Enjoy!",
      time: "2 days ago",
      chatHistory: [
        {
          type: "received",
          text: "Received the scarf, it's beautiful! Thank you so much.",
        },
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                <Card className="h-full">
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-[#3a4043]">
                      {products.length}
                    </div>
                  ...
                  {products.map((product) => (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        />
                        <div>
                          <p className="font-medium text-[#3a4043]">
                            {product.name}
                          </p>
                          <p className="text-sm text-gray-600">
                            {product.category}
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-gray-500 mt-2">
                    Overall earnings from your shop.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-3xl font-bold text-[#3a4043]">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    id="shopDescription"
                    defaultValue="Handcrafted goods and delicious baked treats made with love and unique perspectives."
                  />
                </div>
                <div>
                  <label
                  ...
                  <Input
                    id="contactEmail"
                    type="email"
                    defaultValue="my.shop@example.com"
                  />
                </div>
                <div>
                  <label
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    onValueChange={(value) =>
                      console.log("Payout Frequency:", value)
                    } // Placeholder for actual state update
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-[#3a4043]">
              NeuroMarketplace: My Shop Dashboard
            </h1>
            <p className="text-gray-600 mt-1">
              Manage your unique creations and connect with buyers.
            </p>
          </div>
          {/* <Button>
            <Plus className="mr-2 h-4 w-4" /> Add New Product
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-3 my-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 flex items-center">
                    <MapPin className="h-3 w-3 mr-1" /> Kuala Lumpur
                  </p>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2.5">
                  <div
                    className="bg-[#635bff] h-2.5 rounded-full"
                    style={{ width: "75%" }}
                  ></div>
                </div>
                <p className="text-xs text-gray-500 mt-1">
                  75% Complete - Add more details!
                </p>
              </div>
