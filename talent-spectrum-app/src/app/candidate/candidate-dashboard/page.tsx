...
export default function CandidateDashboard() {
  ...
  //      try {
  //        const email = "alex.johnson@email.com"; // Hardcoded email as requested
  //        const response = await fetch(`http://localhost:8000/profiles/${email}`);
  //       //  console.log(response)
  //        if (response.ok) {
  //          const data = await response.json();
  //          setCandidateProfile({
  //            ...candidateProfile,
  //            personalIdentifiers: data.personal_identifiers
  //          });
  //          setIsLoading(false);
  //        }
  //      } catch (error) {
          ...
          <div className="text-right">
			...
			<div className="space-y-6">
				...
				<Card>
					...
					<ProfileSubmission candidateProfile={candidateProfile} />
					</CardContent>
				</Card>
				</div>
			</div>
