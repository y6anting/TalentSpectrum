...
# # @router.post("/run_matching", summary="Run AI Job Matching for all candidates and jobs")
# # async def run_ai_matching():
# #     """
# #     Endpoint to trigger AI job matching process.
# #     Fetches all candidates and jobs, performs matching using AI, and stores results in database.
# #     """
# #     try:
# #         if not api_key:
# #             raise HTTPException(
...
# #         }
# #     except Exception as e:
# #         raise HTTPException(status_code=500, detail=f"Error during AI matching: {str(e)}")


# # @router.get("/status", summary="Check AI Matching service status")
# # async def get_matching_status():
# #     """
# #     Check if the AI matching service is properly configured.
# #     """
# #     return {
